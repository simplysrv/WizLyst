...
include_once "test_dbinfo.inc.oop.php";
...
<!--  -----------------Header End----------------- -->
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="span4">
				<center><img src="img/ad1.jpg" border="1" alt="Ad Region 1"></center>
				<br />
				...
				<br />
				<br />
				<img src="img/ad1.jpg" border="1" alt="Ad Region 2" style="width:300px; height:250px; border: 1px;">		
